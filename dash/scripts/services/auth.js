angular.module('dockmon.services').factory('authService', ['$http', '$q', '$cookies', '$window', function($http, $q, $cookies, $window) {
    var Base64 = {
    ...
    var getSessionFromCookie = function() {
        ...
        var data = Base64.decode(session).split(':');
    ...
    return {
        ...
        initSession: function() {
            ...
            var _session = this.session || getSessionFromCookie();
            if (!_session) {
